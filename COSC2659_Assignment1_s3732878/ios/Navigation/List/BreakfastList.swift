...
struct BreakfastList: View {
    @Binding var isDarkMode: Bool
    var body: some View {
        //Making list with items that has Breakfast type
        ItemList(listName: "Breakfast", isDarkMode: $isDarkMode)
    }
}//BreakfastList
struct BreakfastList_Previews: PreviewProvider {
    @State static var isDarkMode: Bool = false
    static var previews: some View {
        BreakfastList(isDarkMode: $isDarkMode)
    }
}
